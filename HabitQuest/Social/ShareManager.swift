...
class ShareManager {
    ...
    private func generateStreakImage(streak: Int, habit _: String) -> UIImage? {
...
class ShareManager {
    ...
    func shareAchievement(_: Achievement, completion: @escaping (Bool) -> Void) {
        print("Sharing not supported on this platform")
        completion(false)
    }

    func shareStreak(_: Int, habit _: String, completion: @escaping (Bool) -> Void) {
        print("Sharing not supported on this platform")
        completion(false)
    }

    func shareMilestone(_: StreakMilestone, completion: @escaping (Bool) -> Void) {
        print("Sharing not supported on this platform")
        completion(false)
    }
}
