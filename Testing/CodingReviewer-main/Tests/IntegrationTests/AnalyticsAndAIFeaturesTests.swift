...
final class AnalyticsAndAIFeaturesTests: XCTestCase {
    ...
    func testPatternAnalysisDataAccess() async throws {
        ...
        let patternFiles = [
            CodeFile(
                name: "singleton.swift",
                content: singletonPatternCode,
                language: .swift,
                path: "/patterns/singleton.swift"
            ),
            CodeFile(
                name: "factory.swift",
                content: factoryPatternCode,
                language: .swift,
                path: "/patterns/factory.swift"
            ),
            CodeFile(
                name: "observer.js",
                content: observerPatternCode,
                language: .javascript,
                path: "/patterns/observer.js"
            ),
        ]
