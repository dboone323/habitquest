...
struct NotificationService {
    ...
    static func scheduleHabitReminders(for habits: [Habit]) async {
        ...
        logger.info("Scheduled reminders for \(habits.count) habits")
    }
    ...
    static func sendImmediateNotification(category: NotificationCategory, title: String, body: String, userInfo: [String: Any] = [:]) async {
