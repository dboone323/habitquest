...
run_tests() {
    ...
    xcodebuild test -project "HabitQuest.xcodeproj" -scheme "HabitQuest" -destination 'platform=iOS Simulator,name=iPhone 15,OS=latest' 2>&1 | tee "${SCRIPT_DIR}/logs/test_results.log"
