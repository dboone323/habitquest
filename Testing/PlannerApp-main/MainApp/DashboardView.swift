...
struct DashboardView: View {
    ...
    var body: some View {
        ...
        .onChange(of: showAddGoal) { _, isPresented in
            if !isPresented {
                viewModel.fetchDashboardData()
            }
        }
        .onChange(of: showAddEvent) { _, isPresented in
            if !isPresented {
                viewModel.fetchDashboardData()
            }
        }
        .onChange(of: showAddJournal) { _, isPresented in
            if !isPresented {
                viewModel.fetchDashboardData()
            }
        }
    ...
    private func refreshDataWithDelay() async {
        ...
        // Simulate network delay for pull-to-refresh demonstration
        do {
